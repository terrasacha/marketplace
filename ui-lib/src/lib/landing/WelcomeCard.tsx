  ...
  return (
    <>
      <div className="bg-white rounded-2xl w-[40rem] max-w-[35rem] 2xl:w-[45%] py-10 px-10 sm:px-10 h-auto flex flex-col justify-center">
        ...
        {userData && (
          <button
            className="font-jostBold relative w-full flex items-center justify-center font-jostBold focus:z-10 focus:outline-none text-custom-marca-boton-variante2 bg-transparent enabled:hover:bg-custom-marca-boton-alterno2  dark:bg-cyan-600 dark:enabled:hover:bg-cyan-700  rounded-lg focus:ring-2 px-8 py-2 mt-4"
            onClick={() => {
