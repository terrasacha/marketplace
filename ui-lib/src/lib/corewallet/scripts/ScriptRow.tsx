...
export default function ScriptRow(props: ScriptRowProps) {
  const { index, scriptName, pbk, testnetAddr, tokenName } = props;
  ...
  return (
    <tr className="bg-custom-dark border-b-8 border-custom-fondo">
      ...
      <td className="px-6 py-4">
        <button className="flex justify-center text-custom-dark bg-white hover:bg-[#F6F6F6] focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded text-sm px-5 py-2.5">
          Crear
        </button>
      </td>
    </tr>
