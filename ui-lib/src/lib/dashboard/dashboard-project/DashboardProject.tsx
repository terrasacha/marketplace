...
export default function DashboardProject(props: any) {
  ...
  return (
    <div className="bg-[#F4F8F9] h-auto w-full px-5 pt-6">
      ...
      <h2
        className={`p-4 text-2xl lg:text-3xl ${colors.fuente}  text-gray-900 dark:text-gray-500`}
      >
        {project.name}
      </h2>

      <div
        className={`grid grid-cols-2 lg:grid-cols-2 2xl:grid-cols-4 gap-3 ${colors.fuenteAlterna} `}
      >
        <div
          className={`row-span-4 col-span-2 lg:col-span-1 2xl:col-span-1 lg:row-span-4 ${colors.fuenteAlterna} `}
        >
          <TokenCard
        ...
        <div
          className={`row-span-2 col-span-2 lg:col-span-1 2xl:col-span-3 lg:row-span-2 ${colors.fuenteAlterna} `}
        >
          <Card
            className={`h-fit !bg-custom-dark-hover text-white ${colors.fuente}`}
          >
            <Card.Header title={`Descripción del proyecto`} />
        ...
        <div
          className={`row-span-2 col-span-2 lg:col-span-1 2xl:col-span-3 lg:row-span-2 ${colors.fuenteAlterna} `}
        >
          <PropertiesCard properties={projectData.projectProperties} />
        </div>
        <div className="col-span-2 2xl:col-span-4">
          <button
            onClick={() => router.push(`/projects/${project.id}/purchase`)}
        ...
        <div className="col-span-2 2xl:col-span-4">
          <button
            onClick={() => setIsExpanded(!isExpanded)} // Alternar el estado
            className={`w-full bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600`}
          >
            {isExpanded
              ? 'Ocultar información del proyecto'
              : 'Desplegar información del proyecto'}
          </button>
        </div>
            ...
            {[
              {
                ...
                value: dashboardProjectData.tokensSold
                  ...
                  : '0',
                percentage:
                  dashboardProjectData.relevantInfo.tokenPercentageSold,
                tooltipText:
                  'Cantidad de tokens vendidos del proyecto a inversionistas',
              },
              {
                ...
                tooltipText:
                  'Cantidad de tokens del proyecto en su billetera. Porcentaje respecto a la cantidad de tokens distribuidos para inversionistas.',
              },
              {
                ...
                tooltipText:
                  'Valor total de los tokens del proyecto en su billetera',
              },

              {
                ...
                tooltipText:
                  'Progreso del proyecto respecto a los periodos transcurridos',
              },
              {
                ...
                tooltipText:
                  'Aumento del valor unitario del token respecto al primer pediodo',
              },
              {
      ...
      {isExpanded && (
        <>
          <div
            className={`${colors.fuenteAlterna} grid grid-cols-2 lg:grid-cols-2 2xl:grid-cols-4 gap-3 mt-4`}
          >
            <div
              className={`${colors.fuente} bg-custom-dark-hover p-4 rounded-md shadow-lg col-span-2 row-span-6 lg:col-span-2 2xl:col-span-3 lg:row-span-6 flex flex-col `}
            >
            ...
            {[
              ...
              },
              {
                ...
                image: 'tokens',
                tooltipText:
                  'Cantidad total de tokens disponibles para ser adquiridos por inversionistas',
              },
              {
              ...
              },
              {
                ...
                image: 'calendar',
                tooltipText:
                  'Duración total de la comercialización del proyecto',
              },
            ].map((info, index) => (
