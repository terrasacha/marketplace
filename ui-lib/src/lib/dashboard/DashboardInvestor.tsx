...
function DashboardInvestor(props: { transactions: any[] }) {
  ...
  useEffect(() =>{
    if(assets && walletStakeID){
      mapTransactionListDashboard(transactions, walletStakeID, assets).then(data => setMappedTransactionList(data))
    }
      ...
      <div className="p-4 border-gray-200 rounded-lg">
        ...
        <div className="w-full flex flex-col col-span-3 space-y-5">
            ...
            <Card.Body>
              <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-7 gap-4">
                <div className="relative bg-custom-dark-hover p-5 rounded-md shadow-xl lg:col-span-2 2xl:col-span-5 flex flex-col justify-center items-center max-h-96">
                  ...
                  {mappedTransactionList && <LineChartComponent lineChartData={mappedTransactionList.lineChartData}/>}
                </div>            
                ...
                {mappedTransactionList && <PieChartComponent foundElement={mappedTransactionList.FoundElement}/>}
                </div>
              </div>
            </Card.Body>
          </Card>
          ...
          <Card className="h-fit">
            ...
            <Card.Body>
              <DetailItems foundElement={mappedTransactionList.FoundElement} />
            </Card.Body>
          </Card>
          }
          {
