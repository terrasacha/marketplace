export default async function handler(req, res) {
  ...
  try {
    ...
    const url = `${WALLET_API_BASE}/contracts/${policyId}/mint-protocol`;
    const body = req.body || {};
    ...
    console.error('Error en proxy de mint-protocol:', error);
    return res.status(500).json({
      success: false,
      error: 'Error al procesar la solicitud de mint-protocol',
      details: [
        {
          code: 'proxy_error',
          message:
