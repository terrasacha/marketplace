...
const DashboardItem: React.FC<DashboardItemProps> = ({ icon, value, label }) => {
	return (
		<div className="bg-white dark:bg-[#69a1b3] shadow-lg rounded-md flex items-center justify-between p-4 border-b-4 border-white dark:border-[#588695] text-[#69a1b3] dark:text-gray-800 font-medium group">
...
const ItemsDashboard: React.FC<ItemsDashboardProps> = ({ NewElements }) => {
	...
	return (
		<div className="mb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-4 gap-4">
			<DashboardItem
