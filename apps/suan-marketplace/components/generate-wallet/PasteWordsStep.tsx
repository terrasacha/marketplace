...
const PasteWordsStep = (props: any) => {
  ...
  return (
    <div>
      ...
      <div className="flex gap-2 mt-3 p-4 bg-red-100 rounded-lg">
  <svg
  ...
  <p className="text-sm text-black">
    Estas palabras le permitirán restaurar y acceder a sus fondos en cualquier monedero Cardano. Por favor, escríbalas en papel en el en el orden indicado, y no las almacene en un servicio en línea.
  </p>
</div>

      <WordsContainer useCase="recovery" />
      <p className="w-full rounded-lg p-3 bg-gray-300 text-black text-md font-semibold py-2">
  Empieza a escribir para ver sugerencias de palabras.
      </p>

      <div className="relative w-full mt-2 bg-gray-200"> {/* Fondo gris para el div */}
  ...
  <input
    ...
    className={`w-full rounded-lg pl-10 bg-gray-200 text-black text-lg font-semibold border-2 ${
  ...
  />
      ...
      <div className="flex w-full justify-end mt-6">
        ...
        <button
  className={`group flex h-min items-center justify-center p-2 text-center font-medium focus:z-10 focus:outline-none text-white border border-transparent rounded-lg focus:ring-2 px-8 ml-4 
  ${recoveryWords.join(' ') !== words ? 'bg-gray-400 cursor-not-allowed' : 'bg-black hover:bg-black cursor-pointer'}`}
