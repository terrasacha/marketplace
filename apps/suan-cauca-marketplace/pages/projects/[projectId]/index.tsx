...
import { getActualPeriod } from '@cauca/utils/generic/getActualPeriod';
import { mapProjectData } from '@cauca/lib/mappers';
import dynamic from 'next/dynamic';
import TabsComponents from '@cauca/components/home-page/TabsProject';
const FinancialTab = dynamic(
  () => import('@cauca/components/home-page/ProjectTabs/FinancialTab')
);
const EarningsTab = dynamic(
  () => import('@cauca/components/home-page/ProjectTabs/EarningsTab')
);
const ProjectionsTab = dynamic(
  () => import('@cauca/components/home-page/ProjectTabs/ProjectionsTab')
);
...
const ProjectDataModal = dynamic(
  () => import('@cauca/components/modals/ProjectDataModal')
);
