export default async function handler(req, res) {
  ...
  try {
    ...
    const url = `${WALLET_API_BASE}/wallets/${walletId}/unpromote`;
    ...
    console.error('Error en proxy de unpromote wallet:', error);
    return res.status(500).json({
      success: false,
      error: 'Error al procesar la solicitud de unpromote wallet',
      details: [
        {
          code: 'proxy_error',
