export default async function handler(req, res) {
  ...
  try {
    ...
    let url = `${WALLET_API_BASE}/wallets/${walletId}/addresses`;
    ...
    console.error('Error en proxy de direcciones de billetera:', error);
    return res.status(500).json({
      success: false,
      error: 'Error al procesar la solicitud de direcciones',
      details: [
        {
          code: 'proxy_error',
