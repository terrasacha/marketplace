export default async function handler(req, res) {
  ...
  try {
    ...
    const url = `${WALLET_API_BASE}/contracts/${policyId}/update-protocol`;
    const body = req.body || {};
    ...
    console.error('Error en proxy de update-protocol:', error);
    return res.status(500).json({
      success: false,
      error: 'Error al procesar la solicitud de update-protocol',
      details: [
        {
          code: 'proxy_error',
          message:
