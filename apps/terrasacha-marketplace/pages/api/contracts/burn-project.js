export default async function handler(req, res) {
  ...
  try {
    ...
    const url = `${WALLET_API_BASE}/contracts/burn-project`;
    const body = req.body || {};
    ...
    console.error('Error en proxy de burn-project:', error);
    return res.status(500).json({
      success: false,
      error: 'Error al procesar la solicitud de burn-project',
      details: [
        {
          code: 'proxy_error',
          message:
