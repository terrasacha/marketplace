export default function OwnerInfoCard({ name, docType, docNumber }: any) {
  return (
          ...
          <ul className="general-list pl-1">
            <li className="general-item mb-2">
              <div className="grid sm:grid-cols-2">
                <div className="general-title font-bold">Nombre del titular:</div>
                <div>{name}</div>
              </div>
            </li>
            <li className="general-item mb-2">
              <div className="grid sm:grid-cols-2">
                <div className="general-title font-bold">Identificacion:</div>
